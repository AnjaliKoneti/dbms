Q1 = '''CREATE TABLE User(user_id INTEGER,first_name VARCHAR(200) NOT NULL,last_name VARCHAR(200) NOT NULL,address VARCHAR(300),phone_number INTEGER NOT NULL);'''
Q2 = '''CREATE TABLE Post(user_id INTEGER,post_id INTEGER PRIMARY KEY AUTOINCREMENT,post_content VARCHAR(500));'''
